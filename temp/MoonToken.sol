...
contract MoonToken is ERC20, Ownable, ERC20Burnable, ERC20Pausable, ERC20Permit {
        ...
        ERC20Permit("MoonToken")
    {
        ...
        uint256 totalSupplyValue = 610845221 * 10 ** decimals();
        ...
        _mint(initialOwner, 610845221 * 10 ** decimals());
    }
